...
## Sending logging messages to email, with buffering[](https://docs.python.org/3/howto/logging-cookbook.html#sending-logging-messages-to-email-with-buffering "Link to this heading")
...
1. This should appear twice - once on stderr and once on stdout.
...
2. This should appear once on stderr.
3. This should appear twice - once on stderr and once on stdout.
4. This should appear just once on stderr.
